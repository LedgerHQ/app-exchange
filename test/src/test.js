...
[0x1E, 0x44, 0x2, 0x20, 0x15, 0x1B, 0xDC, 0x77, 0x2C, 0xED,
 0x25, 0x86, 0x3C, 0x59, 0x46, 0xBD, 0xA7, 0x81, 0x24, 0xBC,
 0x15, 0xA4, 0xD, 0x60, 0x2F, 0xBE, 0x45, 0x8F, 0x7E, 0xDB,
 0x84, 0x4, 0x6F, 0x95, 0xC2, 0x81, 0x2, 0x20, 0x69, 0xAA,
 0xC0, 0x35, 0x2B, 0x95, 0x5F, 0x76, 0x79, 0x66, 0xB3, 0x16,
 0xD4, 0x3F, 0xCF, 0xD8, 0x38, 0x20, 0x39, 0x34, 0xB9, 0xDC,
 0xE8, 0xEE, 0x3E, 0x8C, 0xE1, 0x64, 0xBE, 0x57, 0xC1, 0xDF]);
...
test('SetPartnerKey should not throw', async () => {
  ...
  const swap: Swap = new Swap(transport);
  const transactionId: string  = await swap.startNewTransaction();
  await expect(swap.setPartnerKey(Buffer.concat([partnerSerializedNameAndPubKey, DERSignatureOfPartnerNameAndPublicKey]))).resolves.toBe(undefined);
})
