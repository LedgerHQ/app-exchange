...
// 0x3 BTC 0xe Bitcoin Legacy 0x0
const BTCLegacyConfig = Buffer.from([0x3, 0x42, 0x54, 0x43, 0xE, 0x42, 0x69, 0x74, 0x63, 0x6F, 0x69, 0x6E, 0x20, 0x4C, 0x65, 0x67, 0x61, 0x63, 0x79, 0x0]);
const BTCLegacyConfigSignature = Buffer.from([0x30, 0x45, 0x2, 0x21, 0x0, 0x87, 0x97, 0x7A, 0xEF, 0x4A, 0xE, 0xB0, 0x46, 0xF, 0x98, 0x6F, 0xFB, 0x70, 0x1A, 0xDB, 0xBA, 0xB, 0x5A, 0x45, 0xBB, 0x5E, 0x87, 0xC9, 0xC3, 0x15, 0xD1, 0x72, 0xC8, 0xF6, 0xAB, 0xB8, 0x71, 0x2, 0x20, 0x3, 0x7B, 0xB0, 0x78, 0x2, 0x53, 0x9, 0x1A, 0x92, 0xBB, 0xA8, 0x4C, 0x37, 0x76, 0x72, 0x45, 0x63, 0x32, 0x29, 0x87, 0x8D, 0xB, 0xFF, 0x7, 0x27, 0x54, 0x3F, 0x61, 0x31, 0x3E, 0x17, 0x6C]);
...
// 0x3 XTZ 0x5 "Tezos" 0x0
const XTZLegacyConfig = Buffer.from([0x3, 0x58, 0x54, 0x5A, 0x5, 0x54, 0x65, 0x7A, 0x6F, 0x73, 0x0]);
const XTZLegacyConfigSignature = Buffer.from([0x30, 0x44, 0x2, 0x20, 0x53, 0x16, 0x83, 0x34, 0x96, 0x1B, 0x33, 0x39, 0x43, 0x75, 0xBE, 0x35, 0x1B, 0x29, 0x5D, 0xC9, 0x41, 0x3D, 0x68, 0xCE, 0x8C, 0x19, 0x1E, 0x56, 0x3A, 0x22, 0xDC, 0xEB, 0x23, 0x6D, 0x7B, 0x56, 0x2, 0x20, 0x3, 0x30, 0xA3, 0x5A, 0x2D, 0x23, 0xBF, 0x45, 0x54, 0x97, 0x75, 0xB0, 0x6B, 0x7A, 0x8E, 0xCB, 0x14, 0xEC, 0x4, 0xE3, 0xA0, 0x29, 0xFE, 0x48, 0x1F, 0x7F, 0x30, 0x12, 0x4E, 0xF8, 0xB8, 0xE8]);
...
export const XTZ_LEGACY_INFO = new CurrencyInfo("XTZ", "xtz",
                                                "tz1RjJLvt7iguJQnVVWYca2AHDpHYmPJYz4d", "",
                                                "tz1RVYaHiobUKXMfJ47F7Rjxx5tu3LC35WSA", "",
                                                "",
                                                XTZLegacyConfig, XTZLegacyConfigSignature,
                                                getSerializedAddressParameters("44'/1729'/0'/0'"));
...
export const BTC_LEGACY_INFO = new CurrencyInfo("BTC", "btc_legacy",
                                  ...
                                  "",
                                  BTCLegacyConfig, BTCLegacyConfigSignature,
