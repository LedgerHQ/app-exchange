...
class TestTrustedName:
    ...
    def test_trusted_name_missing_field(self, backend, subcommand):
        ...
        for skip in ["structure_type", "version", "trusted_name_type", "trusted_name_source", "trusted_name", "chain_id", "address", "trusted_name_source_contract", "challenge", "signer_key_id", "signer_algo", "der_signature"]:
            with pytest.raises(ExceptionRAPDU) as e:
                ...
                elif skip == "trusted_name_source_contract":
                    ex.send_pki_certificate_and_trusted_name_descriptor(trusted_name_source_contract=None)
                elif skip == "challenge":
