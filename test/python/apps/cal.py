...
from .firmachain import FIRMACHAIN_PACKED_DERIVATION_PATH, FIRMACHAIN_CONF
...
FIRMACHAIN_CURRENCY_CONFIGURATION = CurrencyConfiguration(ticker="FCT", conf=FIRMACHAIN_CONF, packed_derivation_path=FIRMACHAIN_PACKED_DERIVATION_PATH)
