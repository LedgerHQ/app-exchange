...
class ExchangeTestRunner:
    ...
    def perform_test_wrong_refund(self):
    ...
    def perform_test_wrong_payout(self):
        with pytest.raises(ExceptionRAPDU) as e:
    ...
    def perform_test_swap_valid_accepted_1(self):
    ...
    def perform_test_swap_valid_accepted_2(self):
