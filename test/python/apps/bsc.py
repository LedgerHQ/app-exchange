...
class Command:
    ...
    GET_BSC2_PUBLIC_KEY = 0x0E
    SET_BSC2_WITHDRAWAL_INDEX = 0x10
...
class EthereumClient:
    ...
    def __init__(self, client, derivation_path=b''):
        self._client = client
        self._derivation_path = derivation_path or BSC_PACKED_DERIVATION_PATH
    ...
    def sign(self, extra_payload: bytes = bytes.fromhex('eb')):
        # TODO: finish BSC signature with proper payload
