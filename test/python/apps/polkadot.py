...
ERR_SWAP_CHECK_WRONG_METHOD = ExceptionRAPDU(0x6984,b"Swap txn wrong method")
ERR_SWAP_CHECK_WRONG_METHOD_ARGS_CNT = ExceptionRAPDU(0x6984,b"Swap txn wrong method args count")
ERR_SWAP_CHECK_WRONG_DEST_ADDR = ExceptionRAPDU(0x6984,b"Swap txn wrong destination addr")
ERR_SWAP_CHECK_WRONG_AMOUNT = ExceptionRAPDU(0x6984,b"Swap txn wrong amount")
