...
.PHONY: proto
proto:
	make -C nanopb/nanopb-0.3.9.9/generator/proto
	protoc --nanopb_out=. src/proto/protocol.proto --plugin=protoc-gen-nanopb=nanopb/nanopb-0.3.9.9/generator/protoc-gen-nanopb
