...
ifdef BYPASS_CHECK_PARTNER
    $(warning [WARNING] BYPASS_CHECK_PARTNER enabled)
    DEFINES += BYPASS_CHECK_PARTNER
    TEST_BUILD = 1
endif

ifdef BYPASS_CHECK_COIN_CFG
    $(warning [WARNING] BYPASS_CHECK_COIN_CFG enabled)
    DEFINES += BYPASS_CHECK_COIN_CFG
    TEST_BUILD = 1
endif
