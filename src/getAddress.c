...
static const bagl_element_t ui_address_nanos[] = {
    ...
    UI_LABELINE(0x02, "Address", UI_FIRST,  BAGL_FONT_OPEN_SANS_REGULAR_11px,   10),
    UI_LABELINE(0x02, address,   UI_SECOND, BAGL_FONT_OPEN_SANS_EXTRABOLD_11px, 12),
};
...
void handleGetAddress(uint8_t p1, uint8_t p2, uint8_t *dataBuffer, uint16_t dataLength, volatile unsigned int *flags, volatile unsigned int *tx) {
    ...
    snprintf(address, sizeof(address), "12345678901234567890");
