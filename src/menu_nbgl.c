...
static bool displayTransactionPage(uint8_t page, nbgl_pageContent_t* content) {
    ...
    if (page == 0) {
        ...
        content->type = INFO_LONG_PRESS, content->infoLongPress.icon = &C_badge_transaction_56;
...
static void buildFirstPage(void) {
    nbgl_useCaseReviewStart(&C_badge_transaction_56,
                            "Review transaction",
                            NULL,
                            "Reject",
                            reviewContinue,
...
void ui_menu_settings(void) {
    nbgl_useCaseSettings("Exchange settings",
                         0,
                         1,
                         true,
                         ui_idle,
