...
/* Generated by nanopb-0.3.9 at Wed Sep  9 12:22:15 2020. */
...
#define ledger_swap_NewTransactionResponse_init_default \
    { "", "", "", "", "", "", "", "", {0, {0}}, {0, {0}}, "" }
#define ledger_swap_UDecimal_init_default \
    { {0, {0}}, 0 }
#define ledger_swap_NewSellResponse_init_default                       \
    {                                                                  \
        "", "", {0, {0}}, "", "", ledger_swap_UDecimal_init_default, { \
            0, {                                                       \
                0                                                      \
            }                                                          \
        }                                                              \
    }
#define ledger_swap_NewTransactionResponse_init_zero \
    { "", "", "", "", "", "", "", "", {0, {0}}, {0, {0}}, "" }
#define ledger_swap_UDecimal_init_zero \
    { {0, {0}}, 0 }
#define ledger_swap_NewSellResponse_init_zero                       \
    {                                                               \
        "", "", {0, {0}}, "", "", ledger_swap_UDecimal_init_zero, { \
            0, {                                                    \
                0                                                   \
            }                                                       \
        }                                                           \
...
#define ledger_swap_NewTransactionResponse_size 390
