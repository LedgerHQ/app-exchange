...
void init_public_keys(void) {
    ...
    unsigned char ledger_public_key[] = {0x04,                                            //
...
#endif
    CX_ASSERT(cx_ecfp_init_public_key_no_throw(CX_CURVE_SECP256K1,
                                               ledger_public_key,
                                               sizeof(ledger_public_key),
                                               &(G_ledger_public_key)));
}
