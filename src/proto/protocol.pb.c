...
/* Generated by nanopb-0.3.9.9 at Fri Mar  6 09:13:36 2026. */
...
const pb_field_t ledger_swap_NewSellResponse_fields[9] = {
    ...
    PB_FIELD(  8, STRING  , SINGULAR, STATIC  , OTHER, ledger_swap_NewSellResponse, in_extra_id, device_transaction_id, 0),
    PB_LAST_FIELD
};

const pb_field_t ledger_swap_NewFundResponse_fields[8] = {
    ...
    PB_FIELD(  7, STRING  , SINGULAR, STATIC  , OTHER, ledger_swap_NewFundResponse, in_extra_id, device_transaction_id, 0),
    PB_LAST_FIELD
};
